...
The side-port CAD proposal is now in cad/usb-port-study.md (USB-MOUNT-01 v0.2): GCT USB4105-GF-A envelope, fixed-base tabs, a daughterboard outline and raised cosmetic panel. Collision checks are partial geometry evidence, not a routed PCB, functional cover or physical assembly. Keep the charger separate from the small port board; preserve quick battery extraction and adjustable electronics.
