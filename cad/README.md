...
**Полная конструкция RaceRemote ещё не закончена.** Теперь есть [общая 3D-компоновка 0.1](assembly.md) и [автономный просмотрщик](assembly-viewer.html): исходная механика, батарейный узел, предложенная площадка и габаритные резервы электроники. Реальные платы/провода, крепления всех узлов, кузов и магниты ещё не спроектированы полностью. Ниже сохранена документация именно батарейной примерки; изображения сечений не являются чертежами готовой машинки.
