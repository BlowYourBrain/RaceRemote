...
**Актуальная сборка проводки при 0/+3 — [питание и сигнал серво](servo-power/viewer.html), [описание и ограничения](servo-power/README.md).** Включает плату H10 и отдельные провода мотора/XIAO. Реальные концы и крепление жгута, силовой вход остаются открытыми. Более ранняя [компоновка 0.6](current-layout/README.md) содержит исследование регулировок; его результаты не распространяются на новую проводку. Старые сцены ниже — история.
