...
**Актуальная интерактивная сборка — [компоновка 0.6](current-layout/viewer.html), [описание](current-layout/README.md).** Она включает держатель XIAO и направляющие, исправленный USB, обновлённые проверки 144 пар положений. 27 пар проходят твёрдую геометрию/условный кузов; проводка и обслуживание проверены только при 0/+3. Старые сцены ниже — история.
