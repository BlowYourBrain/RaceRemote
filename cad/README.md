...
**Для будущей примерки электроники:** [актуальный комплект из пяти отдельных объектов STL/3MF](current-fit-kit/README.md), включая держатель XIAO с окном питания и поддон с седлом проводов. Это геометрия без G-code; печать отложена.

**Актуальная сборка проводки при 0/+3 — [пара серво со съёмной вязкой](servo-lacing/viewer.html), [описание и ограничения](servo-lacing/README.md).** Включает плату H10 и отдельные провода мотора/XIAO. Реальные концы жгута, физическое удержание и силовой вход остаются открытыми. Более ранняя [компоновка 0.6](current-layout/README.md) содержит исследование регулировок; его результаты не распространяются на новую проводку. Старые сцены ниже — история.

15 сентября: [направляющие жгута 0.1 и обновлённая сборка](harness-guides/README.md). В поддон и прижим встроены два открытых седла под съёмную фиксацию проводов. С новыми деталями проверены начальная посадка, 76 положений снятия кузова, 25 положений упора, 28 положений прижима и непрерывный выход коробки батареи влево. Точки регулировки, физическая затяжка/печать и реальные провода остаются открытыми.
