...
**Актуальная сборка проводки при 0/+3 — [резерв жгута серво](servo-bundle-study/viewer.html), [описание и ограничения](servo-bundle-study/README.md).** Включает предыдущую плату H10 и отдельные провода мотора/XIAO. Реальные концы серво и силовой вход остаются открытыми. Более ранняя [компоновка 0.6](current-layout/README.md) содержит исследование регулировок; его результаты не распространяются на новую проводку. Старые сцены ниже — история.
