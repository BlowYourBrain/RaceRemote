...
**Актуальная сборка проводки при 0/+3 — [сигнал серво от D3](servo-wiring/viewer.html), [описание и ограничения](servo-wiring/README.md).** Включает плату H10 и отдельные провода мотора/XIAO. Кабель и питание серво, силовой вход остаются открытыми. Более ранняя [компоновка 0.6](current-layout/README.md) содержит исследование регулировок; его результаты не распространяются на новую проводку. Старые сцены ниже — история.
