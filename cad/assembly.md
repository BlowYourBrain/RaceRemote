...
Для дальнейшей работы предложена [компоновка под кузов 0.2](body-study.md): условная оболочка и более низкое размещение электроники. Вариант 0.1 ниже сохранён для сравнения; его высота 62 мм не является принятым габаритом машины. Исправлена ориентация: перед по +Y, камера перенесена к рулевой оси.
...
| Камера | 23×12×21 | 13,25; 87; 32 | Резерв компактного модуля класса XIAO в вертикальном положении. Не подтверждает посадку Waveshare CAM-WAV-01, кабелей и угол обзора |
...
- Габариты сцены около **65×123,625×62 мм**, включая исходные колёса и стойку. Совместимость с низким кузовом Mini-Z не подтверждена. Следующая итерация снижает высоту электроники с учётом кузова; увеличивать кузов только для укрытия прежней стопки плат не принято как решение.
