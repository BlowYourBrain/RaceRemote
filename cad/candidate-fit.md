...
**Продолжение от 15 сентября:** [детальная компоновка 0.5](packaging-v05/README.md) заменяет прежние упрощения SG90/Waveshare и заново проверяет регулировки. Результаты 0.4 ниже остаются историческими.
