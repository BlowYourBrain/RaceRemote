...
Продолжение: [CHARGE-PERMIT-01 v0.1](../hardware/charge-permit/README.md)
...
фронты MCU могут разрешить заново. INA300/LATCH, исполнительная цепь CD и
поведение при глубокой просадке с этим узлом ещё не соединены/не проверены.
