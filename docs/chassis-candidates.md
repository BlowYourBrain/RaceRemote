...
Ориентир нашей батареи 49 × 18 × 15 мм отличается от рекомендованных автором примерно 45 × 23 × 16 мм. По одному этому сравнению нельзя ни подтвердить посадку, ни назначить расширение рамы на 4 мм: сначала нужны ориентация батареи, свободный объём, зазоры и вывод проводов. Примерка полного объёма батареи с проводами и кузовом остаётся открытой частью MOUNT-01/SWAP-01. Физические размеры трёх батарей ещё не измерены; печать адаптации не начиналась.
...
Скрипт не меняет исходные STL. Сторонние модели остаются в локальном клоне с лицензией автора; в RaceRemote сохранены только инструмент проверки и результаты измерений.
