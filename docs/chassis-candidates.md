...
Проверено: 13 сентября 2026 года. Статус: первичное изучение, конструкция для серии не выбрана.
...
В GitHub есть STL и исходник `zcar.skp`. README описывает несколько передач с соответствующими креплениями мотора; раздел сборки не завершён. Часть печати выполняется слоями 0,1–0,15 мм; для нагревающихся деталей рассматриваются ABS/PETG. Исходные CAD/STL и профиль печати здесь не скачивались и по геометрии не проверялись.
