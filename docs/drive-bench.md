...
Запрошено, можно ли временно использовать K989 и сколько проводов у её рулевого узла. Пока ответа нет, разборка и подключение K989 не предполагаются выполненными.
