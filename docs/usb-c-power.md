...
Предложение USB-MOUNT-01 v0.3: [CAD-примерка бокового порта](../cad/usb-port-study.md) с GCT USB4105-GF-A и [разведённой пассивной PCB](../hardware/usb-port/README.md) 26×7,6×1 мм. Вход X=59,1 мм, отверстия/площадки экспортированы из KiCad. DRC платы и геометрические проверки прошли; фиксация накладки/жгута, независимая схема и физическая проверка ещё впереди. На плате порта уже есть два Rd 5,1 кОм; основная плата не должна дублировать их. Определение тока источника и защита остаются задачами основного зарядного узла. Общие критерии:
