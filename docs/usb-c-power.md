...
Предложение USB-MOUNT-01 v0.2: [CAD-примерка бокового порта](../cad/usb-port-study.md) с GCT USB4105-GF-A, отдельной маленькой PCB и опорами на неподвижном основании. Добавлены окно в условном кузове и приподнятая накладка; проверены коллизии, путь батареи и резерв штекера. Разводки PCB, фиксации накладки и физической проверки ещё нет. Общие критерии:
