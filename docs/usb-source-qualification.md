...
и BQ25886. Для силовой части теперь создана [схема TPS25200](../hardware/usb-input-gate/README.md), USB-INPUT-GATE-01 v0.1: запрет по умолчанию, отдельный SOURCE_ALLOW, расчётный лимит около 1,18 А. Это не полный вход: AUX/распознавание/изоляция D+/D− и совместимость переходных напряжений с ядром ещё открыты. Источник должен распознаваться при выключенной машинке; запуск
...
Следующий шаг — реализовать питание/распознавание перед подготовленным
