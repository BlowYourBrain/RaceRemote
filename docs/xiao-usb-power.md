...
15 сентября: [подготовлена отдельная альтернатива питания логики](../hardware/xiao-logic-power/README.md) от общего Waveshare через TPS73701/LM66100. Она сохраняет раздельные зарядный/сервисный порты; схема и расчёт ещё не подтверждают пригодность к монтажу. Прежний дополнительный buck ниже остаётся резервным кандидатом.
